...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 33.0, 7.0, 80.5, 40.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 115.5, 10.5, 483.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 499.0, 231.5, 66.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 499.0, 201.5, 107.0, 22.0 ],
					"saved_object_attributes" : 					{
						"versionnumber" : 80001
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "float" ],
					"patching_rect" : [ 425.0, 262.5, 93.0, 22.0 ],
					"saved_object_attributes" : 					{
						"versionnumber" : 80001
					}
,
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 425.0, 293.5, 194.0, 102.5 ],
					"pitcheditrange" : [ "null" ],
					"stafflines" : [ 5, 5, 5 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "float" ],
					"patching_rect" : [ 226.0, 264.5, 148.0, 22.0 ],
					"saved_object_attributes" : 					{
						"versionnumber" : 80001
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "float" ],
					"patching_rect" : [ 4.0, 264.5, 166.5, 22.0 ],
					"saved_object_attributes" : 					{
						"versionnumber" : 80001
					}
,
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 226.0, 295.5, 191.0, 93.666667000000004 ],
					"pitcheditrange" : [ "null" ],
					"stafflines" : [ 5, 5 ],
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"versionnumber" : 80100,
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 4.0, 295.5, 193.0, 73.0 ],
					"pitcheditrange" : [ "null" ],
					"stafflines" : [ 5 ],
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"versionnumber" : 80100,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 4.0, 14.5, 24.0, 24.0 ],
...
, 			{
				"box" : 				{
					...
					"out" : "nnn",
					"outlettype" : [ "", "", "", "bang" ],
					"patching_rect" : [ 425.0, 57.5, 203.021545000000003, 127.0 ],
					"query" : "SELECT * FROM scores",
					"shapefield" : "filename",
					"sizefield" : "loudness",
					"table" : "scores",
					"versionnumber" : 10200,
					"vzoom" : 0.622663479806337,
					"xfield" : "spread",
					"yfield" : "centroid",
...
, 			{
				"box" : 				{
					...
					"out" : "nnnn",
					"outlettype" : [ "", "", "", "", "bang" ],
					"patching_rect" : [ 226.0, 57.5, 191.0, 181.0 ],
					"versionnumber" : 10200,
					"zoom" : 80.0
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnn",
					"outlettype" : [ "", "", "", "", "bang" ],
					"patching_rect" : [ 21.0, 57.5, 193.0, 184.0 ],
					"showdensity" : 1,
					"versionnumber" : 10200,
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 13.5, 254.0, 235.5, 254.0 ],
					"order" : 2,
					"source" : [ "obj-86", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 13.5, 247.0, 434.5, 247.0 ],
					"order" : 0,
					"source" : [ "obj-86", 0 ]
				}
