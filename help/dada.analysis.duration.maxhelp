...
,
					"style" : "",
					"text" : "js helpstarter.js dada.analysis.duration"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 147.0, 471.0, 28.0, 21.0 ],
									"style" : "",
									"text" : "ms"
								}
...
, 							{
								"box" : 								{
									...
									"style" : "",
									"text" : "Dump the roll or score to compute total duration"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 74.0, 435.0, 183.0, 23.0 ],
									"style" : "",
									"text" : "dada.analysis.duration @out t"
								}
...
, 							{
								"box" : 								{
									...
									"id" : "obj-2",
									"ignoreclick" : 1,
									"jsarguments" : [ "dada.analysis.duration", 100 ],
									"maxclass" : "jsui",
									"numinlets" : 1,
									"numoutlets" : 1,
									"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					...
					"id" : "obj-4",
					"ignoreclick" : 1,
					"jsarguments" : [ "dada.analysis.duration" ],
					"maxclass" : "jsui",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 10.0, 10.0, 469.393341, 57.567627 ]
				}
...
, 			{
				"name" : "dada.analysis.duration.maxpat",
