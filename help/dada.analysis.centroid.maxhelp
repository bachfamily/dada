...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 301.0, 205.0, 213.0, 22.0 ],
...
,
					"style" : "",
					"text" : "js helpstarter.js dada.analysis.centroid"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"style" : "",
									"text" : "Dump the roll or score to compute global centroid"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 429.0, 557.583313, 89.0, 21.0 ],
									"style" : "",
									"text" : "Pitch centroid"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 318.0, 495.0, 102.0, 23.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 318.0, 466.0, 130.0, 23.0 ],
									"style" : "",
									"text" : "t b f"
								}
...
, 							{
								"box" : 								{
									...
									"out" : "nnnnnnn",
									"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
									"patching_rect" : [ 318.0, 526.0, 106.0, 84.166667 ],
									"pitcheditrange" : "null",
									"presentation_rect" : [ 0.0, 0.0, 0.0, 84.166667 ],
									"showdurations" : 0,
									"stafflines" : 5,
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 142.0, 526.0, 150.0, 21.0 ],
									"style" : "",
									"text" : "mc"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 74.0, 526.0, 68.0, 23.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 74.0, 435.0, 182.0, 23.0 ],
									"style" : "",
									"text" : "dada.analysis.centroid @out t"
								}
...
, 							{
								"box" : 								{
									...
									"id" : "obj-2",
									"ignoreclick" : 1,
									"jsarguments" : [ "dada.analysis.centroid", 100 ],
									"maxclass" : "jsui",
									"numinlets" : 1,
									"numoutlets" : 1,
									"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					...
					"id" : "obj-4",
					"ignoreclick" : 1,
					"jsarguments" : [ "dada.analysis.centroid" ],
					"maxclass" : "jsui",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 10.0, 10.0, 465.985046, 57.567627 ]
				}
