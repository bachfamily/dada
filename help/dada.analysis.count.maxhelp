...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 300.0, 205.0, 200.0, 22.0 ],
...
,
					"style" : "",
					"text" : "js helpstarter.js dada.analysis.count"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 285.0, 425.5, 313.0, 40.0 ],
									"style" : "",
									"text" : "Set the items to be counted as first argument. Choose among: notes, chords, measures, voices"
								}
...
, 							{
								"box" : 								{
									...
									"style" : "",
									"text" : "Dump the roll or score to count items"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 74.0, 435.0, 203.0, 23.0 ],
									"style" : "",
									"text" : "dada.analysis.count notes @out t"
								}
...
, 							{
								"box" : 								{
									...
									"id" : "obj-2",
									"ignoreclick" : 1,
									"jsarguments" : [ "dada.analysis.count", 100 ],
									"maxclass" : "jsui",
									"numinlets" : 1,
									"numoutlets" : 1,
									"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					...
					"id" : "obj-4",
					"ignoreclick" : 1,
					"jsarguments" : [ "dada.analysis.count" ],
					"maxclass" : "jsui",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 10.0, 10.0, 412.50827, 57.567627 ]
				}
