...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 300.0, 205.0, 207.0, 22.0 ],
...
,
					"style" : "",
					"text" : "js helpstarter.js dada.analysis.spread"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"style" : "",
									"text" : "Dump the roll or score to compute global spread"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 142.0, 471.0, 150.0, 21.0 ],
									"style" : "",
									"text" : "mc"
								}
...
, 							{
								"box" : 								{
									...
									"style" : "",
									"text" : "dada.analysis.spread @out t"
								}
...
, 							{
								"box" : 								{
									...
									"id" : "obj-2",
									"ignoreclick" : 1,
									"jsarguments" : [ "dada.analysis.spread", 100 ],
									"maxclass" : "jsui",
									"numinlets" : 1,
									"numoutlets" : 1,
									"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					...
					"id" : "obj-4",
					"ignoreclick" : 1,
					"jsarguments" : [ "dada.analysis.spread" ],
					"maxclass" : "jsui",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 10.0, 10.0, 432.646057, 57.567627 ]
				}
