...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 301.0, 205.0, 197.0, 22.0 ],
...
,
					"style" : "",
					"text" : "js helpstarter.js dada.terrain.spiral~"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 361.5, 182.0, 196.0, 36.0 ],
									"presentation_rect" : [ 423.0, 312.5, 0.0, 0.0 ],
									"style" : "",
									"text" : "Spiral equation is \nr = a + b*theta",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 622.5, 178.0, 155.0, 40.0 ],
									"style" : "",
									"text" : "Set number of complete turns"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 670.0, 107.0, 77.0, 23.0 ],
									"style" : "",
									"text" : "loadmess 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 652.0, 75.0, 84.0, 23.0 ],
									"style" : "",
									"text" : "loadmess 60"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 575.5, 152.0, 50.0, 23.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 575.5, 182.0, 36.0, 23.0 ],
									"style" : "",
									"text" : "n $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 135.0, 143.0, 32.0, 23.0 ],
									"style" : "",
									"text" : "200"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 95.0, 143.0, 29.5, 23.0 ],
									"style" : "",
									"text" : "1"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 319.5, 152.0, 50.0, 23.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 319.5, 182.0, 36.0, 23.0 ],
									"style" : "",
									"text" : "b $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 633.0, 15.0, 77.0, 23.0 ],
									"style" : "",
									"text" : "loadmess 0"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 255.5, 152.0, 50.0, 23.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 255.5, 182.0, 36.0, 23.0 ],
									"style" : "",
									"text" : "a $1"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 42.0, 271.5, 157.0, 40.0 ],
									"style" : "",
									"text" : "Use the spiral to drive a dada.terrain~"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 107.0, 162.5, 110.0, 40.0 ],
									"style" : "",
									"text" : "Use phasor to drive the spiral"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 371.5, 143.0, 165.0, 40.0 ],
									"style" : "",
									"text" : "Set archimedean spiral parameters"
								}
...
, 							{
								"box" : 								{
									...
									"style" : "",
									"text" : "arguments are: a, b, num_turns, center_x, center_y"
								}
...
, 							{
								"box" : 								{
									...
									"style" : "",
									"text" : "dada.terrain.spiral~ 0 60 2 0 0"
								}
...
, 							{
								"box" : 								{
									...
									"id" : "obj-2",
									"ignoreclick" : 1,
									"jsarguments" : [ "dada.terrain.spiral~" ],
									"maxclass" : "jsui",
									"numinlets" : 1,
									"numoutlets" : 1,
									"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 10.0, 10.0, 407.755859, 57.567627 ]
				}
